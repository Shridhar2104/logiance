...
type ComplexityRoot struct {
	...
	Accounts struct {
		...
		Syncorders func(childComplexity int, syncorders SyncOrdersInput) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Accounts.syncorders":
		if e.complexity.Accounts.Syncorders == nil {
			break
		}

		args, err := ec.field_Accounts_syncorders_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Accounts.Syncorders(childComplexity, args["syncorders"].(SyncOrdersInput)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputStoreIntegrationInput,
		ec.unmarshalInputSyncOrdersInput,
	)
	first := true
...
func (ec *executionContext) field_Accounts_syncorders_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Accounts_syncorders_argsSyncorders(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["syncorders"] = arg0
	return args, nil
}
func (ec *executionContext) field_Accounts_syncorders_argsSyncorders(
	ctx context.Context,
	rawArgs map[string]interface{},
) (SyncOrdersInput, error) {
	// We won't call the directive if the argument is null.
	// Set call_argument_directives_with_null to true to call directives
	// even if the argument is null.
	_, ok := rawArgs["syncorders"]
	if !ok {
		var zeroVal SyncOrdersInput
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("syncorders"))
	if tmp, ok := rawArgs["syncorders"]; ok {
		return ec.unmarshalNSyncOrdersInput2githubᚗcomᚋShridhar2104ᚋlogiloᚋgraphqlᚐSyncOrdersInput(ctx, tmp)
	}
...
func (ec *executionContext) _Accounts_syncorders(ctx context.Context, field graphql.CollectedField, obj *Accounts) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Accounts_syncorders(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Accounts_syncorders(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Accounts",
		Field:      field,
		IsMethod:   false,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Accounts_syncorders_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputStoreIntegrationInput(ctx context.Context, obj interface{}) (StoreIntegrationInput, error) {
	var it StoreIntegrationInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"shopName", "accountId"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSyncOrdersInput(ctx context.Context, obj interface{}) (SyncOrdersInput, error) {
	var it SyncOrdersInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"accountId", "shopName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Accounts(ctx context.Context, sel ast.SelectionSet, obj *Accounts) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "syncorders":
			out.Values[i] = ec._Accounts_syncorders(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNSyncOrdersInput2githubᚗcomᚋShridhar2104ᚋlogiloᚋgraphqlᚐSyncOrdersInput(ctx context.Context, v interface{}) (SyncOrdersInput, error) {
	res, err := ec.unmarshalInputSyncOrdersInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
